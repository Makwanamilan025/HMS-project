    ...
    <div class="min-h-screen flex flex-row bg-gray-100 fixed top-0 gap-16">
        <div class="flex flex-col w-56 bg-white  overflow-hidden">
            <div class="flex items-center justify-center h-[64px] shadow-md">
                ...
                <h1 class="text-2xl uppercase text-black">Hospital</h1>
            </div>
            <ul class="flex flex-col py-4">
                ...
                <li>
                    <a href="{{ route('patient.index') }}"
                        class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
                        <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i class="fa-solid fa-bed-pulse"></i></span>
                        <span class="text-sm font-medium">Pesant</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('bloodbank.index') }}"
                        class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
                        <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i class="fa-solid fa-hand-holding-droplet text-red-600"></i></span>
                ...
                <li>
                    ...
                    class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i class="fa-regular fa-user text-yellow-500"></i></span>
                ...
                <li>
                    <a href=" "
                        class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
                        <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i class="fa-solid fa-right-from-bracket text-black"></i></span>
