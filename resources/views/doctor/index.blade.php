                ...
                <div class="bg-white  shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="flex justify-between">
                            <h1 class="font-bold text-2xl  text-slate-600">Doctors</h1>
                        ...
                        <table class="w-full text-center">
                            ...
                            <tbody>
                                @forelse ($doctors as $doctor)
                                    <tr>
                                        <td class="py-2">
                                            <img src={{ asset('storage/Doctor_images/' . @$doctor->image) }}
                                                alt="img" class=" h-12 w-12 rounded-full mx-auto object-cover">
                                        </td>
